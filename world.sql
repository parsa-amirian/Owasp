...
CREATE TABLE `users` (
  ...
  `profile_picture` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default.png',
...
-- Dump completed on 2025-11-29 22:51:17
